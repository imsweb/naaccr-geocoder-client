...
public class GeocoderTest {
    ...
    public void testCallWithMultipleResults() throws IOException {
        ...
        assertThat(output.getLatitude(), is(0.0));
        assertThat(output.getLongitude(), is(0.0));
        ...
        assertThat(output.getfGeometry(), is(nullValue()));
        assertThat(output.getfGeometrySrid(), is("4269"));
        assertThat(output.getfSource(), is("SOURCE_COUNTY_PARCEL_DATA"));
        assertThat(output.getfVintage(), is("Varies by dataset"));
        assertThat(output.getfPrimaryIdField(), is("ParcelID"));
        ...
        //        assertThat(output.getApiVersion(), is("4.4"));
        //        assertThat(output.getStatusCode(), is(200));
        //        assertThat(output.getLatitude(), is(37.4693199000000));
        //        assertThat(output.getLongitude(), is(-122.429362700000));
        //        assertThat(output.getNaaccrGisCoordinateQualityCode(), is("00"));
        //        assertThat(output.getNaaccrGisCoordinateQualityName(), is("AddressPoint"));
        //        assertThat(output.getMatchScore(), is(63.3136094674556));
        ...
        //        assertThat(output.getMatchingGeographyType(), is("Parcel"));
        //        assertThat(output.getRegionSize(), is(0.0));
        //        assertThat(output.getRegionSizeUnit(), is("Meters"));
        //        assertThat(output.getMatchedLocationType(), is("LOCATION_TYPE_STREET_ADDRESS"));
        //        assertThat(output.getInterpolationType(), is("ArealInterpolation"));
        //        assertThat(output.getInterpolationSubType(), is("ArealInterpolationGeometricCentroid"));
        //        assertThat(output.getFeatureMatchType(), is("Ambiguous"));
        //        assertThat(output.getFeatureMatchTypeNotes(), is("Unknown-None"));
        //        assertThat(output.getFeatureMatchTypeTieBreakingNotes(), is("ReturnAll"));       //These two seem to be reversed...
        //        assertThat(output.getTieHandlingStrategyType(), is(nullValue()));                      //These two seem to be reversed...
        //        assertThat(output.getFeatureMatchingSelectionMethod(), is("FeatureClassBased"));
        //        assertThat(output.getFeatureMatchingSelectionMethodNotes(), is(nullValue()));
        ...
        //        assertThat(output.getParsedAddress().getZipPlus4(), is(nullValue()));
        //        assertThat(output.getParsedAddress().getZipPlus5(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getNumber(), is("123"));
        //        assertThat(output.getFeatureAddress().getPreDirectional(), is(nullValue()));
        ...
        //        assertThat(output.getfGeometry(), is(nullValue()));
        //        assertThat(output.getfGeometrySrid(), is("4269"));
        //        assertThat(output.getfSource(), is("SOURCE_OPENADDRESSES"));
        //        assertThat(output.getfVintage(), is("2017"));
        //        assertThat(output.getfPrimaryIdField(), is("uniqueId"));
        //        assertThat(output.getfPrimaryIdValue(), is("9570330"));
        //        assertThat(output.getfSecondaryIdField(), is("source"));
        //        assertThat(output.getfSecondaryIdValue(), is("http://maps.smcgov.org/GIS_data_download/SAN_MATEO_COUNTY_PARCELS.zip"));
        //        assertThat(output.getNaaccrCensusTractCertaintyCode(), is("1"));
        //        assertThat(output.getNaaccrCensusTractCertaintyName(), is("ResidenceStreetAddress"));
        //        assertThat(c1990.getBlock(), is(nullValue()));
        //        assertThat(c1990.getBlockGroup(), is(nullValue()));
        //        assertThat(c1990.getTract(), is("6135.00"));
        //        assertThat(c1990.getCountyFips(), is("081"));
        ...
        //        assertThat(c2000.getBlock(), is("2045"));
        //        assertThat(c2000.getBlockGroup(), is("2"));
        //        assertThat(c2000.getTract(), is("6135.01"));
        //        assertThat(c2000.getCountyFips(), is("081"));
        //        assertThat(c2000.getCbsaFips(), is("41860"));
        //        assertThat(c2000.getCbsaMicro(), is("0"));
        //        assertThat(c2000.getMcdFips(), is("93120"));
        //        assertThat(c2000.getMetDivFips(), is("41884"));
        //        assertThat(c2000.getMsaFips(), is("7362"));
        //        assertThat(c2000.getPlaceFips(), is("31708"));
        //        assertThat(c2000.getStateFips(), is("06"));
        //        assertThat(c2010.getBlock(), is("2076"));
        //        assertThat(c2010.getBlockGroup(), is("2"));
        //        assertThat(c2010.getTract(), is("6135.01"));
        //        assertThat(c2010.getCountyFips(), is("081"));
        //        assertThat(c2010.getCbsaFips(), is("41860"));
        //        assertThat(c2010.getCbsaMicro(), is("0"));
        //        assertThat(c2010.getMcdFips(), is("91215"));
        //        assertThat(c2010.getMetDivFips(), is("41884"));
        //        assertThat(c2010.getMsaFips(), is("7362"));
        //        assertThat(c2010.getPlaceFips(), is("31708"));
        ...
        //        assertThat(output.getApiVersion(), is("4.4"));
        //        assertThat(output.getStatusCode(), is(200));
        //        assertThat(output.getLatitude(), is(39.1235872000000));
        //        assertThat(output.getLongitude(), is(-121.617250300000));
        //        assertThat(output.getNaaccrGisCoordinateQualityCode(), is("00"));
        //        assertThat(output.getNaaccrGisCoordinateQualityName(), is("AddressPoint"));
        //        assertThat(output.getMatchScore(), is(63.3136094674556));
        //        assertThat(output.getMatchType(), is("Relaxed"));
        ...
        //        assertThat(output.getFeatureAddress().getConsolidatedCity(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getMinorCivilDivision(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getCounty(), is("sutter"));
        //        assertThat(output.getFeatureAddress().getCountySubregion(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getZipPlus1(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getZipPlus2(), is(nullValue()));
        //        assertThat(output.getFeatureAddress().getZipPlus3(), is(nullValue()));
        ...
        //        assertThat(output.getfVintage(), is("2017"));
        //        assertThat(output.getfPrimaryIdField(), is("uniqueId"));
        //        assertThat(output.getfPrimaryIdValue(), is("10219445"));
        //        assertThat(output.getfSecondaryIdField(), is("source"));
        //        assertThat(output.getfSecondaryIdValue(), is("https://services6.arcgis.com/rHMUPKWdiOvdGXkw/ArcGIS/rest/services/Tax_Parcels/FeatureServer/0"));
        //        assertThat(output.getNaaccrCensusTractCertaintyCode(), is("1"));
        //        assertThat(output.getNaaccrCensusTractCertaintyName(), is("ResidenceStreetAddress"));
        //        assertThat(c1990.getBlock(), is(nullValue()));
        //        assertThat(c1990.getBlockGroup(), is(nullValue()));
        //        assertThat(c1990.getTract(), is("0503.00"));
        //        assertThat(c1990.getCountyFips(), is("101"));
        //        assertThat(c1990.getCbsaFips(), is(nullValue()));
        //        assertThat(c1990.getCbsaMicro(), is(nullValue()));
        //        assertThat(c1990.getMcdFips(), is(nullValue()));
        //        assertThat(c1990.getMetDivFips(), is(nullValue()));
        ...
        //        assertThat(c1990.getPlaceFips(), is(nullValue()));
        //        assertThat(c1990.getStateFips(), is("06"));
        //        assertThat(c2000.getBlock(), is("1014"));
        //        assertThat(c2000.getBlockGroup(), is("1"));
        //        assertThat(c2000.getTract(), is("0503.02"));
        //        assertThat(c2000.getCountyFips(), is("101"));
        //        assertThat(c2000.getCbsaFips(), is("49700"));
        //        assertThat(c2000.getCbsaMicro(), is("0"));
        //        assertThat(c2000.getMcdFips(), is("93820"));
        //        assertThat(c2000.getMetDivFips(), is(nullValue()));
        //        assertThat(c2000.getMsaFips(), is("9340"));
        //        assertThat(c2000.getPlaceFips(), is("86972"));
        //        assertThat(c2000.getStateFips(), is("06"));
        //        assertThat(c2010.getBlock(), is("1011"));
        //        assertThat(c2010.getBlockGroup(), is("1"));
        //        assertThat(c2010.getTract(), is("0503.02"));
        //        assertThat(c2010.getCountyFips(), is("101"));
        //        assertThat(c2010.getCbsaFips(), is("49700"));
        //        assertThat(c2010.getCbsaMicro(), is("0"));
        //        assertThat(c2010.getMcdFips(), is("93820"));
        //        assertThat(c2010.getMetDivFips(), is(nullValue()));
        //        assertThat(c2010.getMsaFips(), is("9340"));
        //        assertThat(c2010.getPlaceFips(), is("86972"));
        //        assertThat(c2010.getStateFips(), is("06"));
